...
export default function InvoiceDetailPage() {
  ...
  const handleWhatsAppSend = () => {
    ...
    const paymentInfo = invoice.payment_link_url
      ...
      : "";
    const message = `Hi ${invoice.clients?.name},\n\nHope you're doing well. Here is the invoice *${invoice.invoice_number}* for *${formatCurrency(
      invoice.grand_total,
    )}*.\n\nDue Date: ${formatDate(
      invoice.due_date,
    )}${paymentInfo}\n\nThanks,\n${profile.company_name}`;
    const whatsappUrl = `https://wa.me/${invoice.clients?.phone?.replace(
      /\D/g,
      "",
  ...
  const handleGeneratePaymentLink = async () => {
    ...
    try {
      const link = await createRazorpayPaymentLink(invoice, invoice.clients);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <CardContent className="pt-8">
              ...
              <div className="grid grid-cols-2 gap-8 mb-8 border-t border-b py-6">
                <div>
                  ...
                  <h4 className="font-bold text-sm">{invoice.clients?.name}</h4>
          ...
          <Card className="border-[#25D366]/20 bg-gradient-to-br from-[#25D366]/5 to-transparent">
            ...
            <CardContent className="space-y-4">
              ...
              <WhatsAppShareButton
                ...
                businessName={profile?.company_name || "MsgBill"}
        ...
        <div className="md:col-span-1 space-y-6">
          <Card className="bg-gradient-to-br from-primary-600 to-primary-500 text-white border-none">
            <CardHeader>
              <CardTitle className="text-white text-sm">Amount Due</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-xs">Invoice Details</CardTitle>
            </CardHeader>
            <CardContent className="space-y-2 text-xs">
              ...
              {invoice.payment_link_url && (
                <div className="pt-2 border-t">
                  <span className="text-secondary-500">Payment Link:</span>
                  <a
